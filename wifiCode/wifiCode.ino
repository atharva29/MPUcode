...
String ssid = "BMS" ; // wifi ssid
String password = "BMS123123123"; // wifi password
String ip = "192.168.15.187" ; // ip address of server
  ...
  if (count == 0 ) {
    ...
    if (client1.connected()) {
      if (client1.available() > 0 ) { // server is sending some data
        ...
        if(Serial.available()){
            client1.println("1,"+Serial.readStringUntil('\n'));     
          }
      }
